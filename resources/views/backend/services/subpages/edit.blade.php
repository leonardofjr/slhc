...
@section('content')
    ...
    <form id="service_form_edit" class="p-4" action="/services/{{$data->id}}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control {{ $errors->has('service_name') ? ' is-invalid' : '' }}" id="service_name" name="service_name" value="{{ old('service_name', $data->service_name) }}"  placeholder="Enter name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control {{ $errors->has('service_chinese_name') ? ' is-invalid' : '' }}" id="service_chinese_name" name="service_chinese_name"  value="{{ old('service_name', $data->service_chinese_name) }}"   placeholder="Enter the chinese name for the service">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control {{ $errors->has('service_price') ? ' is-invalid' : '' }}" id="service_price" name="service_price" value="{{ old('service_price', $data->service_price) }}"  placeholder="20.00">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control {{ $errors->has('short_description') ? ' is-invalid' : '' }}" id="short_description" name="short_description" value="{{ old('short_description') }}"  placeholder="Enter a short description">{{ old('short_description', $data->short_description) }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control {{ $errors->has('detailed_description') ? ' is-invalid' : '' }}" id="detailed_description" name="detailed_description"   placeholder="Enter a description">{{ old('detailed_description', $data->detailed_description) }}</textarea>
